...
class Instructor:
    ...
    def __int__(self,opt):
        ...
        if 'bert' in opt.model_name:
            ...
            tokenizer = build_tokenizer(fnames=[opt.dataset_file['train'], opt.datasets_file['test']], max_seq_len=opt.max_seq_len, dat_fname='{0}_tokenizer.dat'.format(opt.dataset))
