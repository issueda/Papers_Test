...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', type=str, default=proj_root+"/data/prep_data/")
    parser.add_argument('--model_dir', type=str, default=proj_root+"/data/model/")
    ...
    if args.domain == 'restaurant':
        command = "java -cp /home/uyplayer/Github/六篇论文实验/DE-CNN/script/A.jar absa16.Do Eval -prd /home/uyplayer/Github/六篇论文实验/DE-CNN/data/official_data/pred.xml -gld /home/uyplayer/Github/六篇论文实验/DE-CNN/data/official_data/EN_REST_SB1_TEST.xml.gold -evs 2 -phs A -sbt SB1"
        template = "data/official_data/EN_REST_SB1_TEST.xml.A"
    elif args.domain == 'laptop':
        command = "java -cp /home/uyplayer/Github/六篇论文实验/DE-CNN/script/eval.jar Main.Aspects /home/uyplayer/Github/六篇论文实验/DE-CNN/data/official_data/pred.xml /home/uyplayer/Github/六篇论文实验/DE-CNN/data/official_data/Laptops_Test_Gold.xml"
